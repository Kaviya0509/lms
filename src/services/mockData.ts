...
export const mockTrainers: Trainer[] = [
  ...
  { id: 't5', name: 'Suresh Nataraj', email: 'suresh@lms.com', mobile: '9432109876', qualification: 'M.Sc Cybersecurity', expertise: ['Multi-Agent Frameworks', 'AI Safety', 'VAPT'], experience: 9, certifications: ['CEH', 'CISSP', 'CompTIA Security+'], bio: 'Certified ethical hacker with government and enterprise experience.', availability: 'full-time', status: 'active', assignedCourses: ['c_claude_arch_prof'], avatar: 'https://randomuser.me/api/portraits/men/76.jpg', joinedAt: '2023-03-15', totalBatches: 2, rating: 4.5 },
];
