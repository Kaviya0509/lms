...
export const mockTrainers: Trainer[] = [
  { id: 't1', name: 'Dr. Arun Kumar', email: 'arun@lms.com', mobile: '9876543210', qualification: 'Ph.D Computer Science', expertise: ['Anthropic SDK', 'AI Workflows', 'Python'], experience: 12, certifications: ['AWS Solutions Architect', 'Google Cloud Professional'], bio: 'Senior full-stack architect with 12 years in enterprise development.', availability: 'full-time', status: 'active', assignedCourses: ['c_claude_dev', 'c_claude_arch_found'], joinedAt: '2022-03-15', totalBatches: 4, rating: 4.8 },
  { id: 't2', name: 'Meena Subramaniam', email: 'meena@lms.com', mobile: '9765432109', qualification: 'M.Tech Data Science', expertise: ['Python', 'Prompt Engineering', 'Generative AI'], experience: 8, certifications: ['TensorFlow Developer', 'Microsoft Azure AI'], bio: 'ML engineer specializing in production-grade AI systems.', availability: 'full-time', status: 'active', assignedCourses: ['c_claude_assoc'], joinedAt: '2023-01-10', totalBatches: 2, rating: 4.9 },
  { id: 't3', name: 'Rajesh Pillai', email: 'rajesh@lms.com', mobile: '9654321098', qualification: 'B.Tech ECE', expertise: ['Java', 'Spring Boot', 'Microservices'], experience: 10, certifications: ['Oracle Java SE', 'Spring Professional'], bio: 'Backend specialist with deep expertise in distributed systems.', availability: 'part-time', status: 'active', assignedCourses: [], joinedAt: '2022-08-20', totalBatches: 0, rating: 4.6 },
  { id: 't4', name: 'Divya Ramesh', email: 'divya@lms.com', mobile: '9543210987', qualification: 'MBA IT', expertise: ['UI/UX', 'Figma', 'Design Thinking'], experience: 6, certifications: ['Google UX Design', 'Interaction Design Foundation'], bio: 'UX specialist focused on accessibility and human-centered design.', availability: 'contract', status: 'inactive', assignedCourses: [], joinedAt: '2023-06-01', totalBatches: 0, rating: 4.7 },
  { id: 't5', name: 'Suresh Nataraj', email: 'suresh@lms.com', mobile: '9432109876', qualification: 'M.Sc Cybersecurity', expertise: ['Multi-Agent Frameworks', 'AI Safety', 'VAPT'], experience: 9, certifications: ['CEH', 'CISSP', 'CompTIA Security+'], bio: 'Certified ethical hacker with government and enterprise experience.', availability: 'full-time', status: 'active', assignedCourses: ['c_claude_arch_prof'], joinedAt: '2023-03-15', totalBatches: 2, rating: 4.5 },
];

export const mockTrainees: Trainee[] = [
  { id: 'tr1', name: 'Aarav Sharma', email: 'aarav@email.com', mobile: '9811111111', type: 'fresher', location: 'Chennai', status: 'active', enrolledCourses: ['c_claude_assoc'], assignedBatch: 'b_claude_assoc_off', overallProgress: 72, attendancePercentage: 88, joinedAt: '2024-01-15' },
  { id: 'tr2', name: 'Priya Nair', email: 'priya@email.com', mobile: '9822222222', type: 'professional', company: 'TCS', experience: 3, location: 'Bangalore', status: 'active', enrolledCourses: ['c_claude_dev'], assignedBatch: 'b_claude_dev_on', overallProgress: 45, attendancePercentage: 62, joinedAt: '2024-02-20' },
  { id: 'tr3', name: 'Karthik Raja', email: 'karthik@email.com', mobile: '9833333333', type: 'fresher', location: 'Hyderabad', status: 'active', enrolledCourses: ['c_claude_assoc'], assignedBatch: 'b_claude_assoc_off', overallProgress: 91, attendancePercentage: 96, joinedAt: '2024-01-15' },
  { id: 'tr4', name: 'Ananya Reddy', email: 'ananya@email.com', mobile: '9844444444', type: 'professional', company: 'Wipro', experience: 5, location: 'Chennai', status: 'pending', enrolledCourses: ['c_claude_arch_prof'], overallProgress: 0, attendancePercentage: 0, joinedAt: '2024-08-01' },
  { id: 'tr5', name: 'Vijay Kumar', email: 'vijay@email.com', mobile: '9855555555', type: 'fresher', location: 'Mumbai', status: 'active', enrolledCourses: ['c_claude_arch_found'], assignedBatch: 'b_claude_arch_found_off', overallProgress: 30, attendancePercentage: 55, joinedAt: '2024-03-10' },
  { id: 'tr6', name: 'Lakshmi Menon', email: 'lakshmi@email.com', mobile: '9866666666', type: 'professional', company: 'Infosys', experience: 2, location: 'Pune', status: 'active', enrolledCourses: ['c_claude_dev'], assignedBatch: 'b_claude_dev_on', overallProgress: 68, attendancePercentage: 80, joinedAt: '2024-02-20' },
];
